...
export function ProjectsPage() {
  const projects = [
    ...
    },
    {
      ...
      description: 'A comprehensive social media analytics dashboard with real-time data visualization.',
      image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80',
      technologies: ['Vue.js', 'D3.js', 'Node.js', 'PostgreSQL'],
    },
    {
      title: 'Healthcare Management System',
      description: 'A secure healthcare management system for patient records and appointment scheduling.',
